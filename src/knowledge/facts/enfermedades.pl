...
enfermedad(bronquitis_aguda).
enfermedad(neumonia).
enfermedad(asma).
enfermedad(epoc).
enfermedad(gastroenteritis).
enfermedad(gastritis).
enfermedad(reflujo_gastroesofagico).
enfermedad(intoxicacion_alimentaria).
enfermedad(sindrome_del_intestino_irritable).
enfermedad(estrenimiento).
enfermedad(diarrea_aguda).
enfermedad(colitis).
